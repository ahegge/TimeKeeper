        ...
        BlackButtonBackground {
            ...
            RowLayout {
                ...
                Button {
                    ...
                    Layout.preferredWidth: root.height * 0.100
                    Layout.alignment: Qt.AlignCenter
                    Image {
                        id: icon
                        source: "qrc:/images/glyphicons-174-play.png"
                        fillMode: Image.PreserveAspectFit
                        anchors.centerIn: parent
                    }
                    style: BlackButtonMediaStyle {}
                    onClicked: {
                        console.log(task_id)
                        if(state == false){
                            icon.source = "qrc:/images/glyphicons-175-pause.png"
                            state = true
                        }else{
                            icon.source = "qrc:/images/glyphicons-174-play.png"
                            state = false
                        }
                    }
                }
